      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-6">
        <div>
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-[#45475a] border-2 md:border-4 border-[#45475a] flex items-center justify-center flex-shrink-0">
              <User className="w-10 h-10 md:w-12 md:h-12 text-[#f9e2af]" />
            </div>
